...
type SummaryViewProps = {
  ...
  initialRiskScore?: GenerateRiskScoreOutput;
  initialTimeline?: TimelineEvent[];
  initialNegotiationSuggestions?: NegotiationSuggestion[];
...
const SummaryView = ({
  ...
  const [riskScore, setRiskScore] = useState<GenerateRiskScoreOutput | null>(initialRiskScore || null);
  ...
  const [negotiationSuggestions, setNegotiationSuggestions] = useState<NegotiationSuggestion[]>(initialNegotiationSuggestions || []);
